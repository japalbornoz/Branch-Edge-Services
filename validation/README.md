...
Validation evidence includes CLI outputs (`show` commands), endpoint tests (ping/name resolution), and expected pass/fail results based on the access-control policy.
